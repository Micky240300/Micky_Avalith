...
function postLogin() {
    ...
    const data = { "user": user, "password": password };
        ...
        .then( res =>{ 
            ...
            message.innerHTML =  `<h6 class= "text-success">Ha iniciado sesion correctamente</h6>`;
            dataUser.innerHTML = `          <input id="user" name="user" type="text" placeholder="User" required autofocus>
            `;
